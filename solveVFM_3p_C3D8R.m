function [A, C, K, strain] = solveVFM_3p_C3D8R(u, uVF1, uVF2, uVF3, rho, omega, nodesSubZone, elemSubZone, globalNodeNums, orientation, GaussPoints)
...
for i = 1:size(elemSubZone,1)
    ...
    eVF1_V = B*UeVF1; % Strain of virtual displacement field
    eVF2_V = B*UeVF2; % Strain of virtual displacement field
    eVF3_V = B*UeVF3; % Strain of virtual displacement field
    ...
    c_k1 = detJ*trace(eRot)*trace(eVF1Rot);
    c_k2 = detJ*trace(eRot)*trace(eVF2Rot);
    c_k3 = detJ*trace(eRot)*trace(eVF3Rot);
    c_k = [c_k1; c_k2; c_k3];
    
    % Calculate each component of the A matrix
    
    % mu12 - full integration
