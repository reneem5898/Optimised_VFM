function [C1, C2, C3, C4, C5, H] = C3D8R_5p(U, nodesSubZone, elemSubZone, globalNodeNums, paramInit, orientation)
...
%         C33_app*conj(C13_app) * N25 + conj(C44_app)*C13_app * N35 + C44_app*conj(C13_app) * N35;
    ...
    C1(localNodeIdcs) = C1(localNodeIdcs) + f_c11*w;
    C2(localNodeIdcs) = C2(localNodeIdcs) + f_c33*w;
    C3(localNodeIdcs) = C3(localNodeIdcs) + f_c44*w;
    C4(localNodeIdcs) = C4(localNodeIdcs) + f_c66*w;
	C5(localNodeIdcs) = C5(localNodeIdcs) + f_c13*w;
