...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Given the nodes and element connectivity, this function returns the 
% nodes which are on the bounary of the model or subregion
%
% Inputs: 1) nodes - node numbers and coordinates
