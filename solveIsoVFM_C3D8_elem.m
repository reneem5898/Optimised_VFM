function [FK, FG, B, strain] = solveIsoVFM_C3D8_elem(u, uVF, rho, omega, nodesSubZone, elemSubZone, globalNodeNums)
...
for i = 1:size(elemSubZone,1)
    ...
    % Compile element by element A1, A2 and B
    FK(i) = A1_3; %LHS - bulk component
    FG(i) = A2_3; %LHS - shear component
    B(i) = B_3; %RHS - acceleration/inertial term
