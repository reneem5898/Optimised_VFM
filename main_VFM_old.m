function [subZoneResults] = main_VFM_old(modelDir, refParams, noise, num_MonteCarlo, subzones, rho, f, outDir, vs, elemType, GaussPoints, fibreNoise)
